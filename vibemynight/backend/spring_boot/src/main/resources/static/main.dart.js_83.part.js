...
$__dart_deferred_initializers__.current=function(a,b,c,$){var J,A,C,F,G,E,I,H,K,L,M,N,B={
bla(){return new B.vd(null)},
...
aPf:function aPf(){},
aPg:function aPg(d){this.a=d}},D,O
J=c[1]
A=c[0]
C=c[2]
F=c[39]
...
u===$&&A.a()
w=2
return A.w(s.cg(u.HC("/admin/facilities/"+e.a+"/status",r,x.z)),$async$Ek)
case 2:r=$.zk()
...
p===$&&A.a()
w=8
return A.w(q.cg(p.lx(0,"/admin/facilities/"+g.a,x.z)),$async$xm)
case 8:p=$.zk()
...
B.yG.prototype={
W(){return new B.Ny(new A.aX(null,x.w))}}
B.Ny.prototype={
...
if(w==null)w=""
s.z!==$&&A.at()
s.z=new A.aR(new A.aT(w,C.I,C.B),t)},
...
i===$&&A.a()
w=10
return A.w(j.cg(i.rI(0,"/admin/facilities/"+l,p,k)),$async$x7)
case 10:w=8
break
case 9:l=o.a
j=l.a
j===$&&A.a()
w=11
return A.w(l.cg(j.h1("/admin/facilities",p,k)),$async$x7)
case 11:case 8:l=$.zk()
if(m.e==null)A.V(A.O(y.b))
m.gbA().bG(l)
m=q.c
if(m!=null)A.bR(m,!1).by(null)
r.push(6)
w=5
break
case 4:t=3
...
return G.jH(A.b([A.dY(E.cm,new B.adR(d),w),A.dY(E.e7,new B.adS(d),w)],x.p),w,w,w,v)},
$S:z+1}
B.adR.prototype={
...
$S:37}
B.ae1.prototype={
$2(d,e){return new A.dF(J.bv(d),new B.adY(this.a),null)},
$S:26}
B.adY.prototype={
$0(){var w=this.a,v=$.zk()
...
$S:293}
B.adZ.prototype={
$2(d,e){var w,v,u,t,s=null,r=J.bd(this.b,e),q=A.v(r.b,s,s,s,s,s,s,s,s),p=r.d
p=p!=null?A.v(p,s,s,s,s,s,s,s,s):s
w=r.e
v=this.a
u=this.c
